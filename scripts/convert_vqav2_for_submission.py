...
if __name__ == '__main__':
    ...
    args = parse_args()
    breakpoint()
    src = os.path.join(args.dir, 'answers', args.split, "X1len_100", "topk_0", args.ckpt, 'merge.jsonl')
    test_split = os.path.join(args.dir, 'llava_vqav2_mscoco_test2015.jsonl')
    dst = os.path.join(args.dir, 'answers_upload', args.split, f'{args.ckpt}_100.json')
